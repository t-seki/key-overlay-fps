...
namespace KeyOverlayFPS.Tests
{
    ...
    public class MouseTrackerTests
    {
        ...
        public void MouseDirection_Values_AreInCorrectOrder()
        {
            ...
            Assert.AreEqual(5, (int)MouseDirection.NorthNorthWest);
            Assert.AreEqual(6, (int)MouseDirection.NorthWest);
            Assert.AreEqual(7, (int)MouseDirection.WestNorthWest);
            Assert.AreEqual(8, (int)MouseDirection.West);
            Assert.AreEqual(9, (int)MouseDirection.WestSouthWest);
            Assert.AreEqual(10, (int)MouseDirection.SouthWest);
            Assert.AreEqual(11, (int)MouseDirection.SouthSouthWest);
            Assert.AreEqual(12, (int)MouseDirection.South);
            Assert.AreEqual(13, (int)MouseDirection.SouthSouthEast);
            Assert.AreEqual(14, (int)MouseDirection.SouthEast);
